...
#include "middleware/fat/ff.h"			/* Declarations of FatFs API */
#include "middleware/fat/diskio.h"		/* Declarations of disk I/O functions */
...
)
{
	...
	if (disk_write(pdrv, fs->win.d8/*tbl*/, b_vol, 1) != RES_OK)	/* Write it to the VBR sector */
		return FR_DISK_ERR;
